  ...
  try {
    ...
    if (deviceConfig.deviceId && deviceConfig.deviceName) {
      ...
      checks.push({
        ...
        fix: 'Run: ccnotify pair <6-digit-code>'
      });
    ...
    console.log(chalk.gray('  ccnotify setup          Configure hooks and environment'));
    console.log(chalk.gray('  ccnotify pair <code>    Pair with iPhone'));
    console.log(chalk.gray('  ccnotify test           Send test notification'));
